...
| `closeButtonAriaLabel`   | `close-button-aria-label`   | The aria-label of the close / "X" button (displayed when `trigger="controlled"`). This will default to "Close drawer".                                      | `string \| undefined`                    | `undefined`  |
